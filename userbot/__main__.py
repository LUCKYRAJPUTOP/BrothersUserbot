...
print("BrothersUserbot has been deployed! ")

print("Setting up BrothersUserbot")
...
if Config.ENABLE_ASSISTANTBOT == "ENABLE":
    ...
    sed.info("BrothersUserbot  Bot Have Been Installed Successfully !")
else:
    sed.info("BrothersUserbot Has Been Installed Sucessfully !")
    sed.info("You Can Visit @brothers_support For Any Support Or Doubts")
